...
| V3 static split routing | `deepseek_v3_static.json` | Functional acceptance; fixed `r=1` deployment contract |
...
| DeepSeek-V3 dynamic end-to-end generation | `run_deepseek_v3.sh` + frozen profile | Sole Experiment 4 endpoint; hardware-verified on 2×A800; API PASS |
