...
if CUDA_HOME is not None or ROCM_HOME is not None:
    ops_module = CUDAExtension('KTransformersOps', [
        ...
        'csrc/ktransformers_ext/cuda/custom_gguf/gguf_kernel.cu',
        'csrc/ktransformers_ext/cuda/custom_gguf/activation_kernels.cu',
        'csrc/ktransformers_ext/cuda/custom_gguf/moe_align_sum_kernels.cu'
    ],
    extra_compile_args={
