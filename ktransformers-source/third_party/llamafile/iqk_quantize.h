...
void   quantize_row_iq1_s_r4_with_residual_ref(const float * GGML_RESTRICT x, block_iq1_s_r4  * GGML_RESTRICT y, int64_t k);
void   quantize_row_iq1_s_r4_with_residual(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
size_t quantize_iq1_s_r4_with_residual(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
void   dequantize_row_iq1_s_r4_with_residual(const block_iq1_s_r4  * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
void   vec_dot_iq1_s_r4_res_q8_k(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);

void   quantize_row_iq1_s_with_residual_q2_k_sepa(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
size_t quantize_iq1_s_with_residual_q2_k_sepa(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix, int64_t nrows_all);
void   dequantize_row_iq1_s_with_residual_q2_k_sepa(const block_iq1_s_r4  * GGML_RESTRICT x1, const block_q2_k_r4  * GGML_RESTRICT x2, float * GGML_RESTRICT y, int64_t k, int64_t nrows_all);
void   vec_dot_iq1_s__res__q2_k_sepa_q8_k(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);

void   quantize_row_iq1_m_with_residual_q2_k_r4(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
size_t quantize_iq1_m_with_residual_q2_k_r4(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
void   dequantize_row_iq1_m_with_residual_q2_k_r4(const block_iq1_m_r4  * GGML_RESTRICT x1, const block_q2_k_r4  * GGML_RESTRICT x2, float * GGML_RESTRICT y, int64_t k, int64_t nrows_all);
void   vec_dot_iq1_m__res__q2_k_r4_q8_k(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);
