...
#include "ggml.h"
#include "../llamafile/iqk_quantize.h"
...
//#endif
    ...
    [GGML_TYPE_Q8_0_X4] = {
        ...
        .from_float_reference      = quantize_row_q8_0_x4,
        .nrows                    = 1,
        .row_meta_size            = 0,
    },
    [GGML_TYPE_Q8_1_X4] = {
        ...
        .from_float_reference     = quantize_row_q8_1_x4,
        .nrows                    = 1,
        .row_meta_size            = 0,
    },
    [GGML_TYPE_Q2_K] = {
    ...
    [GGML_TYPE_Q2_K_R4] = {
        ...
        .from_float_reference     = (ggml_from_float_t) quantize_row_q2_k_r4_ref,
    ...
    [GGML_TYPE_Q4_K_R4] = {
        ...
        .type_size                = sizeof(block_q4_K),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q4_k_r4,
        .from_float               = quantize_row_q4_k_r4,
        .from_float_reference     = (ggml_from_float_t) quantize_row_q4_k_r4_ref,
    ...
    [GGML_TYPE_IQ1_S] = {
        ...
        .from_float_reference     = (ggml_from_float_t)quantize_row_iq1_s_reference,
    ...
    [GGML_TYPE_IQ1_S_R4] = {
        ...
        .from_float_reference           = (ggml_from_float_t)quantize_row_iq1_s_r4_ref,
    ...
    // to do: wwx
    // vec_dot is not implemented,since it requires specific cpu optimization
    [GGML_TYPE_IQ1_S_R4_RES] = {
        .type_name                = "iq1_s_r4_res",
        .blck_size                = 32,
        .type_size                = sizeof(block_iq1_s_r4)/2,
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_iq1_s_r4_with_residual,
        .from_float               = quantize_row_iq1_s_r4_with_residual,
        .from_float_reference           = (ggml_from_float_t)quantize_row_iq1_s_r4_with_residual_ref,
        .vec_dot                  = vec_dot_iq1_s_r4_res_q8_k,
        .vec_dot_type             = GGML_TYPE_Q8_K128,
        .nrows                    = 1,
        .row_meta_size            = 4,
    },
    [GGML_TYPE_IQ1_S_R4_RES_Q2_K] = {
        .type_name                = "iq1_s_r4_res_q2_k",
        .blck_size                = QK_K,
        .type_size                = sizeof(block_iq1_s_r4)/4 *(QK_K/32)+ sizeof(block_q2_K),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_iq1_s_with_residual_q2_k_sepa,
        .from_float               = quantize_row_iq1_s_with_residual_q2_k_sepa,
        .from_float_reference     = NULL,
        .vec_dot                  = vec_dot_iq1_s__res__q2_k_sepa_q8_k,
        .vec_dot_type             = GGML_TYPE_Q8_K128,
        .nrows                    = 1,
        .row_meta_size            = 2,
    },
    [GGML_TYPE_IQ1_S_R4_RES_Q2_K_RO] = {
        .type_name                = "iq1_s_r4_res_q2_k_ro",
        .blck_size                = QK_K,
        .type_size                = sizeof(block_iq1_s_r4)/4 *(QK_K/32)+ sizeof(block_q2_K),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_iq1_s_with_residual_q2_k_sepa, // invalid
        .from_float               = quantize_row_iq1_s_with_residual_q2_k_sepa, // invalid
        .from_float_reference     = NULL,
        .vec_dot                  = vec_dot_iq1_s__res__q2_k_sepa_q8_k, // invalid
        .vec_dot_type             = GGML_TYPE_Q8_K128,
        .nrows                    = 1,
        .row_meta_size            = 2,
    },
    [GGML_TYPE_IQ1_M_R4_RES_Q2_K] = {
        .type_name                = "iq1_m_r4_res_q2_k",
        .blck_size                = QK_K,
        .type_size                = sizeof(block_iq1_m_r4)/4 *(QK_K/32)+ sizeof(block_q2_K),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_iq1_m_with_residual_q2_k_r4,
        .from_float               = quantize_row_iq1_m_with_residual_q2_k_r4,
        .from_float_reference     = NULL,
        .vec_dot                  = vec_dot_iq1_m__res__q2_k_r4_q8_k,
        .vec_dot_type             = GGML_TYPE_Q8_K128,     // 改回q8_k128
        .nrows                    = 1,
        .row_meta_size            = 2,
    },
    [GGML_TYPE_IQ1_M_PLUS_Q4_K_R4] = {
        .type_name                = "iq1_m_plus_q4_k_r4",
        .blck_size                = QK_K,
        .type_size                = sizeof(block_iq1_m_r4)/4 *(QK_K/32)+ sizeof(block_q4_K),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q4_k_r4,
        .from_float               = quantize_row_q4_k_r4,
        .from_float_reference     = NULL,
    ...
    [GGML_TYPE_IQ1_M_R4_RES_Q2_K_RO] = {
        .type_name                = "iq1_m_r4_res_q2_k_ro",
        .blck_size                = QK_K,
        .type_size                = sizeof(block_iq1_m_r4)/4 *(QK_K/32)+ sizeof(block_q2_K),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_iq1_m_with_residual_q2_k_r4,
    ...
    [GGML_TYPE_IQ1_M_R4] = {
        ...
        .from_float_reference     = (ggml_from_float_t)quantize_row_iq1_m_r4_ref,
...
enum ggml_type ggml_ftype_to_ggml_type(enum ggml_ftype ftype) {
    ...
    switch (ftype) {
        ...
        case GGML_FTYPE_MOSTLY_IQ1_S_R4_RES:  wtype = GGML_TYPE_IQ1_S_R4_RES;    break;
        case GGML_FTYPE_MOSTLY_IQ1_S_R4_RES_Q2_K: wtype = GGML_TYPE_IQ1_S_R4_RES_Q2_K; break;
        case GGML_FTYPE_MOSTLY_IQ1_M_R4_RES_Q2_K: wtype = GGML_TYPE_IQ1_M_R4_RES_Q2_K; break;
        case GGML_FTYPE_MOSTLY_IQ1_M_PLUS_Q4_K_R4: wtype = GGML_TYPE_IQ1_M_PLUS_Q4_K_R4; break;
...
void ggml_quantize_init(enum ggml_type type) {
    ...
    switch (type) {
        ...
        case GGML_TYPE_IQ1_S_R4_RES:iq2xs_init_impl(GGML_TYPE_IQ1_S); break;
        case GGML_TYPE_IQ1_S_R4_RES_Q2_K: iq2xs_init_impl(GGML_TYPE_IQ1_S); break;
        case GGML_TYPE_IQ1_M_R4_RES_Q2_K: iq2xs_init_impl(GGML_TYPE_IQ1_M); break;
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_IQ1_S_R4_RES:result = quantize_iq1_s_r4_with_residual(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_IQ1_S_R4_RES_Q2_K: assert (false); break; // not supported RES_Q2_K Quant in this repo
        case GGML_TYPE_IQ1_M_R4_RES_Q2_K: assert (false); break;
        case GGML_TYPE_IQ1_M_PLUS_Q4_K_R4: assert(false); break;
