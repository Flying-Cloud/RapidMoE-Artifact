...
class Config(metaclass=Singleton):
    ...
    def load() -> dict:
        ...
        localstore_path: str = os.environ.get(
            "RAPIDMOE_STATE_DIR", os.path.join(user_path, ".ktransformers")
        )
    ...
    def __init__(self):
        ...
        self.localstore_path: str = os.environ.get(
            "RAPIDMOE_STATE_DIR", os.path.join(self.user_path, ".ktransformers")
        )
        # log configs
